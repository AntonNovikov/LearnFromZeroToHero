...
canvasWidth = 750
canvasHeight = 500
canvasBg = "dodgerblue4"
score = 0
bounceCount = 0

# def creatCanvas(width, height, bg):
window = tkinter.Tk()
canvas = tkinter.Canvas(window, width=canvasWidth,
                        height=canvasHeight, bg=canvasBg)
canvas.pack()
...
# creatCanvas(canvasWidth, canvasHeight, canvasBg)
