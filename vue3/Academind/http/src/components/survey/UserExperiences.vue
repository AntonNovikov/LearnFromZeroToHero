...
export default {
  ...
  methods: {
    loadExperiences() {
      this.isLoading = true;
      this.error = null;
      // fetch("https://vue-http-demo-c5473-default-rtdb.firebaseio.com/surveys.json")
      fetch("https://vue-http-demo-c5473-default-rtdb.firebaseio.com/surveys.json") // for error
        .then((res) => {
          if (res.ok) {
            return res.json();
          }
