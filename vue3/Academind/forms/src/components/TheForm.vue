<template>
  <form @submit.prevent="submitForm">
    <div class="form-control" :class="{invalid: userNameValidity === 'invalid'}">
      ...
      <input focus id="user-name" name="user-name" type="text" v-model.trim="userName" @blur="validateInput"/>
...
<rating-control v-model="rating"></rating-control>
    ...
    <div class="form-control">
      ...
      <label for="confirm-terms">Agree to trems of use?</label>
    </div>
    <div>
...
export default {
  ...
  methods: {
    submitForm() {
      ...
      this.referrer = 'wom'
      console.log('check' + this.interest)
